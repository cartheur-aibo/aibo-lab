# R-Code Behavior Extract: `C-Tracking3.R`
...
- family: `C-Tracking`
- variant: `v3`
- source: `src/R-CODE/sample/C-Tracking3.R`
- states: `4`
- transitions: `5`
- commands: `MOVE=3, GO=2, WAIT=2, SET=1, POSE=1, IF=1, PLAY=1`
